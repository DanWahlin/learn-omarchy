...
var ARCADE_CATALOG = [
    { steps: ["omarchy-tour/tour-workspace-two", "workspaces/workspaces-jump", "first-real-session/finale-to-two"],
        action: "workspace-2", category: "workspaces", difficulty: "starter", prompt: "Switch to workspace 2" },
    { steps: ["omarchy-tour/tour-workspace-one", "workspaces/workspaces-home", "first-real-session/finale-home", "first-real-session/finale-back-to-one"],
    ...
    { steps: ["everyday-apps/launch-terminal", "windows/windows-open-first", "windows/windows-open-second", "workspaces/workspaces-open-terminal", "first-real-session/finale-terminal"],
        action: "launch-terminal", category: "apps", difficulty: "starter", prompt: "Open a terminal" },
    { steps: ["everyday-apps/close-terminal", "everyday-apps/close-files", "windows/windows-close-one", "windows/windows-close-two", "workspaces/workspaces-close", "useful-tools/tools-monitor-close", "useful-tools/tools-calculator-close", "first-real-session/finale-close-terminal", "first-real-session/finale-close-browser"],
    ...
    { steps: ["everyday-apps/launch-browser", "first-real-session/finale-browser"],
    ...
    { steps: ["workspaces/workspaces-send", "workspaces/workspaces-restore", "first-real-session/finale-send-browser"],
